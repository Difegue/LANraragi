...
#Just do everything 
apk update 
apk add perl perl-io-socket-ssl perl-dev redis libarchive-dev libbz2 openssl-dev zlib-dev imagemagick imagemagick-dev imagemagick-libs
...
apk del perl-dev g++ make gnupg wget curl nodejs nodejs-npm openssl-dev imagemagick-dev
