...
You can also search for galleries with a specific number of pages read or unread with similar syntax, `read:20`/`unread:20`, or with a range: `read:>20, read:<=30`.
