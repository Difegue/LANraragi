...
note('testing composite search: per-clause newonly OR untaggedonly...');
{
    ...
    is_deeply( [sort @union_ids], [sort ("e4c422fd10943dc169e3489a38cdbf57101a5f7e", "4857fd2e7c00db8b0af0337b94055d8445118630")],
        'newonly OR untaggedonly should return Rohan and Ghost in the Shell' );
}
...
note('testing tri-state newonly: exclude new archives...');
{
    ...
    is_deeply( [sort @result_ids], [sort grep { $_ ne "e4c422fd10943dc169e3489a38cdbf57101a5f7e" } @all_archive_ids],
        'Exclude new should return all archives except Rohan' );
}
...
note('testing tri-state combined: tagged AND non-new...');
{
    ...
    my @expected = sort grep { $_ ne "4857fd2e7c00db8b0af0337b94055d8445118630" && $_ ne "e4c422fd10943dc169e3489a38cdbf57101a5f7e" } @all_archive_ids;
    is_deeply( [sort @result_ids], \@expected,
        'Tagged AND non-new should exclude Rohan and Ghost in the Shell' );
}
