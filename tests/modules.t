...
my @modules = (
    ...
    "LANraragi::Utils::Logging",                   "LANraragi::Controller::Api",
    ...
    "LANraragi::Model::Api",                       "LANraragi::Model::Backup",
    ...
    "LANraragi::Plugin::Scripts::FavtagMigration", "LANraragi::Plugin::Scripts::EHDL"
);
