...
my $motd = "Welcome to this Library running LANraragi v.0.1.75!"; 
...
#Generate thumbnails on library index creation? (When index.html is generated by index.pl) 
#Might be a bad idea if you have a lot of archives whose thumbnails haven't been gen'd. Or a bad CPU. 
#(Shit starts timing out on around 200-300 archives with a dual core machine. I should work in some AJAX to avoid timeouts but w/e)
my $generateonindex = 1;
